    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="#" class="brand-logo">
                {{-- <img class="logo-abbr" src="{{ asset ('dashboard') }}/images/bibo-logo.png" alt=""> --}}
                {{-- <img class="logo-compact" src="{{ asset ('dashboard') }}/images/bibo-logo.png" alt=""> --}}
                <img class="brand-title" src="{{ asset ('dashboard') }}/images/bibo.png" alt="">
            </a>
        ...
        ***********************************-->
        ...
        <li><a href="{{ route('shipping') }}" class="ai-icon" aria-expanded="false" target="_blank">
            <i class="fa fa-car"></i>
            <span class="nav-text">Shipping</span>
        </a>
       </li>
        <li><a href="{{ route('coupon.index') }}" class="ai-icon" aria-expanded="false" target="_blank">
            <i class="fa fa-money"></i>
            <span class="nav-text">Coupon</span>
        </a>
       </li>
        <li><a href="{{ route('order.index') }}" class="ai-icon" aria-expanded="false" target="_blank">
            <i class="fa fa-modx"></i>
            <span class="nav-text">Order</span>
            <div id="order_status" class="badge bg-danger badge-md text-white">{{ \App\Models\new_order_summeries::where('delivery_status', 'pending')->count() }}</div>
            {{-- <div class="badge badge-success" id="order_amount">
                {{ App\Models\new_order_summeries::where('delivery_status','pending')->count() }}
            </div> --}}
        </a>
       </li>
       <li><a href="{{ route('back.blog') }}" class="ai-icon" aria-expanded="false" target="_blank">
        <i class="fa fa-database"></i>
        <span class="nav-text">Blog</span>
    </a>
   </li>
       <li><a href="{{ route('upcoming.product') }}" class="ai-icon" aria-expanded="false" target="_blank">
        <i class="fa fa-upload"></i>
        <span class="nav-text">Upcoming Product</span>
    </a>
   </li>
				...
				<div class="copyright">
					<p><strong>BiboTrend Admin Dashboard</strong> © 2022 All Rights Reserved</p>
					<p>Made with <span class="heart"></span> by FeenixLab</p>
				</div>
			</div>
        </div>
        <!--**********************************
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="https://feenixlab.com/" target="_blank">FeenixLab</a> 2022</p>
            </div>
        </div>
        <!--**********************************
            Footer end
